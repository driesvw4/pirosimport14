...
class PirosStaffingCandidate(models.Model):
    ...
    _description = 'piros_staffing candidate'
...
class PirosStaffingAmIintermediate(models.Model):
    ...
    _description = 'piros_staffing am_im'
...
class PirosStaffingRole(models.Model):
    ...
    _description = 'piros_staffing function'
...
class PirosStaffingSubcontractor(models.Model):
    ...
    _description = 'piros_staffing subcontractor'
...
class PirosStaffingEndcustomer(models.Model):
    ...
    _description = 'piros_staffing endcustomer'
...
class PirosStaffingProposal(models.Model):
    ...
    _description = 'piros_staffing proposal'
    ...
    def onchange_tracking(self):
        if self.x_piros_staffing_proposal_candidate.name:
            self._cr.execute(
                'SELECT x_piros_staffing_candidate_donotpropose FROM piros_staffing_candidate WHERE name=%s and x_piros_staffing_candidate_donotpropose',
                (self.x_piros_staffing_proposal_candidate.name,))
...
class PirosStaffingCandidateProposedFunctions(models.Model):
    ...
    _description = 'piros_staffing candidateproposedfunctions'
