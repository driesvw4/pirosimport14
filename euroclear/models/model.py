...
class EuroclearProposal(models.Model):
    ...
    def onchange_tracking(self):
        if self.x_euroclear_proposal_candidate.name:
          self._cr.execute('SELECT x_euroclear_candidate_donotpropose FROM euroclear_candidate WHERE name=%s and x_euroclear_candidate_donotpropose', (self.x_euroclear_proposal_candidate.name,))
